<x-layout>
    <div class="max-w-lg mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-red-600 mb-6 text-center">Delete Certificate</h2>
        <form action="{{ route('certificates.destroy', $certificate->id) }}" method="POST">
            @csrf
            @method('DELETE')

            <p class="text-lg text-gray-800 mb-4 text-center">Are you sure you want to delete this certificate? This action cannot be undone.</p>
            ...
            <div class="flex flex-col items-center gap-4">
                ...
                <a href="{{ route('certificates.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white py-2 px-4 rounded-md transition duration-300">
                    Cancel
                </a>
            </div>
        </form>
